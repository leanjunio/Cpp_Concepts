; Listing generated by Microsoft (R) Optimizing Compiler Version 19.14.26433.0 
	...
	TITLE	C:\Dev\HelloWorld\HelloWorld\Log.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0BA@GDPKBKJ@Initialized?5Log?$AA@		; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BA@GDPKBKJ@Initialized?5Log?$AA@
CONST	SEGMENT
??_C@_0BA@GDPKBKJ@Initialized?5Log?$AA@ DB 'Initialized Log', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; File c:\dev\helloworld\helloworld\log.cpp
; Line 6
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	...
	rep stosd
; Line 7
	push	OFFSET ??_C@_0BA@GDPKBKJ@Initialized?5Log?$AA@
...
; File c:\program files (x86)\microsoft visual studio\2017\community\vc\tools\msvc\14.14.26428\include\iosfwd
; Line 523
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
